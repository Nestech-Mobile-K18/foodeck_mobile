...
class _CartViewState extends State<CartView> {
  ...
  late Future<void> _requestShowListCart;

  @override
  void initState() {
    super.initState();
    _viewModel = CartViewModel();
    _requestShowListCart = _viewModel.requestShowListCart();
    _viewModel.getProposedFoods();
    _viewModel.getCoupon();
  }

  Future<void> _refreshListCart() async {
    setState(() {
      _requestShowListCart = _viewModel.requestShowListCart();
    });
  }
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              FutureBuilder(
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    final cartItems = _viewModel.cartItems;
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ListTile(
                              ...
                              trailing: IconButton(
                                onPressed: () async {
                                  await _viewModel
                                      .removeItemFromCart(item.idFood ?? '');
                                  _refreshListCart();
                                },
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: FutureBuilder(
                        future: _viewModel.getProposedFoods(),
                        builder: (context, snapshot) {
                          if (snapshot.connectionState ==
                            ...
                            final proposedFoods = _viewModel.proposedFoods;
                            if (proposedFoods.isEmpty) {
                              return const Center(
                                  child:
                                      Text('There are no recommended dishes'));
                            } else {
              ...
              FutureBuilder(
                future: _viewModel.requestShowListCart(),
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    return const Center(child: CircularProgressIndicator());
                  } else if (snapshot.hasError) {
                          ...
                          Column(
                            children: [
                              ListTile(
                                ...
                                trailing: CustomText(
                                  title:
                                      '\$${_viewModel.getTotalPrice().toStringAsFixed(0)}',
                              ...
                              ListTile(
                                ...
                                trailing: CustomText(
                                  title:
                                      '-\$${_viewModel.selectedCouponValue?.toStringAsFixed(0) ?? '0'}',
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    CustomText(
                                      title:
                                          '\$${(_viewModel.getDiscountedTotalPrice() + deliveryFee + vat).toStringAsFixed(0)}',
                                      color: ColorsGlobal.globalBlack,
                                      size: 28,
                                      fontWeight: FontWeight.bold,
                                    ),
