...
import '../../food_menu/views/food_variations_view.dart';
    ...
    return ChangeNotifierProvider(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          },icon: const Icon(Icons.arrow_back, color: ColorsGlobal.globalBlack,)),
        ),
          ...
          child: Column(
            ...
            children: [
              ...
              Consumer<CartViewModel>(
                builder: (context, viewModel, child) {
                  if (viewModel.cartItems.isEmpty) {
                    return Container(); // Hide Columns if cartItems are empty
                  } else {
                    return Column(
                      children: [
                        Container(
